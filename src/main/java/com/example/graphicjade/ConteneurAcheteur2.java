...
public class ConteneurAcheteur2 extends Application {
    protected Acheteur2 acheteur;
    ...
    public void start(Stage primaryStage)  {
        startcontainer2();
        primaryStage.setTitle("Acheteur2");
    ...
    public void startcontainer2() {
        try{
            ...
            AgentController agentController1=agentContainer1.createNewAgent("Acheteur2","com.example.graphicjade.Acheteur2", new Object[]{this});
