...
public class ConteneurAcheteur3 extends Application {
    protected Acheteur3 acheteur;
    ...
    public void start(Stage primaryStage)  {
        startcontainer2();
        primaryStage.setTitle("Acheteur3");
    ...
    public void startcontainer2() {
        try{
            ...
            AgentController agentController1=agentContainer1.createNewAgent("Acheteur3","com.example.graphicjade.Acheteur3", new Object[]{this});
