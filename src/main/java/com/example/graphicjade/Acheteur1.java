...
public class Acheteur1 extends GuiAgent {
    protected ConteneurAcheteur1 conteneurAcheteur1;

    @Override
    protected void setup() {
        conteneurAcheteur1=(ConteneurAcheteur1)getArguments()[0];
        conteneurAcheteur1.acheteur=this;
            ...
            public void action() {
                ...
                if (msg!=null) {
                    if (msg.getPerformative() == ACLMessage.CFP) {
                        conteneurAcheteur1.afficherMessage(msg);
                        ...
                        //ajoute 20%
                        rp.setContent(String.valueOf((Double.parseDouble((msg.getContent())))*1.2));
                        send(rp);
                    }
                    if (msg.getPerformative() == ACLMessage.ACCEPT_PROPOSAL) {
                        // pour repondre au message
                        conteneurAcheteur1.afficherMessageConclu(msg);
