...
public class ConteneurAcheteur1 extends Application {
    protected Acheteur1 acheteur;
    ...
    public void start(Stage primaryStage)  {
        startcontainer2();
        primaryStage.setTitle("Acheteur1");
    ...
    public void startcontainer2() {
        try{
            ...
            AgentController agentController1=agentContainer1.createNewAgent("Acheteur1","com.example.graphicjade.Acheteur1", new Object[]{this});
